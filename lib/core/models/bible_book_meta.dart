...
class BibleBookMeta {
  ...
  static const Map<String, String> descriptions = {
    ...
    'tb':   'Tobie retrouve la vue grâce à l\'ange Raphaël. Un conte de foi familiale sur la Providence.',
    'jdt':  'Judith, veuve courageuse, sauve son peuple en décapitant le général Holopherne. Symbole de l\'Église.',
    '1mac': 'La résistance héroïque des Maccabées contre l\'hellénisation forcée d\'Israël au IIe siècle av. J.-C.',
    '2mac': 'Martyre, résurrection des morts et prière pour les défunts. Fondement catholique du purgatoire.',
    'wis':  'La sagesse divine mène à la vie éternelle. Méditation sur la Providence et la victoire du juste.',
    'sir':  'L\'Ecclésiastique : guide de sagesse pratique pour bien vivre. Très présent dans la liturgie.',
    'bar':  'Lettre de consolation et hymne à la Sagesse pour le peuple en exil à Babylone.',
